<template>
	<div
		class="pull-request-row rounded mb-1 pr-5 p-2 flex justify-between items-center bg-slate-100 cursor-pointer border-l-4 border-transparent hover:border-l-4 hover:border-blue-600 hover:-translate-x-1 hover:bg-slate-200 transition ease-in-out duration-100"
		:class="classes"
